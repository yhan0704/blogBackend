...
3. Run the **`backend-reviewer`** agent (`.claude/agents/backend-reviewer.md`) on the pending changes. Its role, checklist, and report format are defined in that file.
